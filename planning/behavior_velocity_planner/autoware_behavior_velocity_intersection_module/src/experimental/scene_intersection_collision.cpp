  ...
  const PlannerData & planner_data)
{
  ...
  for (auto & object_info : object_info_manager_.attentionObjects()) {
    ...
    for (const auto & predicted_path_ptr : sorted_predicted_paths) {
      ...
      RCLCPP_WARN(rclcpp::get_logger("debug_message"), "From info, prepared");
      ...
      RCLCPP_WARN(rclcpp::get_logger("debug_message"), "From info, created");
      if (!trimmed_ego_polygon_opt.has_value()) {
        RCLCPP_WARN(rclcpp::get_logger("debug_message"), "From info, empty");
        continue;
      }
      RCLCPP_WARN(rclcpp::get_logger("debug_message"), "From info, go");
