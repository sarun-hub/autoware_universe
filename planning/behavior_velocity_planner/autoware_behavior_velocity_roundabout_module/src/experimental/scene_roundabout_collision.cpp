  ...
  const PlannerData & planner_data)
{
  ...
  for (auto & object_info : object_info_manager_.attentionObjects()) {
    ...
    for (const auto & predicted_path_ptr : sorted_predicted_paths) {
      ...
      RCLCPP_WARN(rclcpp::get_logger("debug_message"), "From exp roundabout, prepared");
      ...
      RCLCPP_WARN(rclcpp::get_logger("debug_message"), "From exp roundabout, created");
      if (!trimmed_ego_polygon_opt.has_value()) {
        RCLCPP_WARN(rclcpp::get_logger("debug_message"), "From exp roundabout, empty");
        continue;
      }
      RCLCPP_WARN(rclcpp::get_logger("debug_message"), "From exp roundabout, go");
